...
public class SparkTweetsWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length == 0) {
            args = new String[10];
            args[0] = "src/main/resources/data/twitterdata/tweets.txt";
            args[1] = "src/main/resources/data/twitterdataout/tweetsdataout";
            args[2] = "src/main/resources/data/twitterdataout/tweetsdataouttemp1";
            args[3] = "src/main/resources/data/twitterdataout/tweetsdataouttemp2";
	...
	//	FileUtils.deleteQuietly(new File(outputPath));
        ...
        JavaPairRDD<String, Integer> counts2 = rdd.flatMap(x -> Arrays.asList(x.split(" ")).iterator())
                .mapToPair(x -> new Tuple2<>(x, 1))
                .reduceByKey((x, y) -> x + y);
        ...
        counts.map( x-> x._1() + "," + x._2()).coalesce(1,true).saveAsTextFile(args[1]);
		sc.close();
